    ...
    return (
        <div className="SectionListCars">
            ...
            <div className="filter-button">
                <button
                    className={`buttonfilter ${activeFilter === "All" ? "active" : "disabled"}`}
                    onClick={() => handleFilterClick("All")}
                >
                    All
                </button>
                <button
                    className={`buttonfilter ${activeFilter === "small" ? "active" : "disabled"}`}
                    onClick={() => handleFilterClick("small")}
                >
                    Small
                </button>
                <button
                    className={`buttonfilter ${activeFilter === "medium" ? "active" : "disabled"}`}
                    onClick={() => handleFilterClick("medium")}
                >
                    Medium
                </button>
                <button
                    className={`buttonfilter ${activeFilter === "large" ? "active" : "disabled"}`}
                    ...
                    <div key={car.id} className="HeadCardCar">
                        ...
                        <div className="BodyCardCar">
                            ...
                            <div className="desc-card">
                                <p className="body-14-light">{format(new Date(car.start_date), 'dd/MM/yyyy')} - {format(new Date(car.end_date), 'dd/MM/yyyy')}</p>
                            </div>
                            <div className="desc-card">
